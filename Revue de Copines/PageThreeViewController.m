...
- (void)viewDidAppear:(BOOL)animated {
    self.hvc.pageControl.currentPage = 2;
    [self.hvc drawTitle:3];
...
- (void) scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    //self.hvc.currentArticle3 = _currentArticle;
...
- (void)parseCopines:(NSInteger)userId {
    ...
    //NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%d&cat=%ld", userId, (long)user.theme2];
    NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%ld&cat=%d", (long)userId, 2];
    ...
    HomeViewController *myHomeViewController = (HomeViewController *)self.parentViewController;
    //myHomeViewController.lastUpdate3 = [res objectForKey:@"date"];
    
    //self.hvc.articlesData3 = _articlesData;
    //self.hvc.currentArticle3 = _currentArticle;
...
- (void)preUpdateCopines:(NSInteger)userId {
    ...
    //NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%ld&cat=%ld", (long)userId, (long)user.theme2];
    NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%ld&cat=%d", (long)userId, 2];
