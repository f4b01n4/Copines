...
- (void)viewDidAppear:(BOOL)animated {
    self.hvc.pageControl.currentPage = 1;
    [self.hvc drawTitle:2];
...
- (void) scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    //self.hvc.currentArticle2 = _currentArticle;
...
- (void)parseCopines:(NSInteger)userId {
    ...
    //NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%d&cat=%ld", userId, (long)user.theme1];
    NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%ld&cat=%d", (long)userId, 1];
    ...
    HomeViewController *myHomeViewController = (HomeViewController *)self.parentViewController;
    //myHomeViewController.lastUpdate2 = [res objectForKey:@"date"];
    
    //self.hvc.articlesData2 = _articlesData;
    //self.hvc.currentArticle2 = _currentArticle;
...
- (void)preUpdateCopines:(NSInteger)userId {
    ...
    //NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%ld&cat=%ld", (long)userId, (long)user.theme1];
    NSString *sUrl = [NSString stringWithFormat:@"http://adlead.dynip.sapo.pt/revue-de-copines/back/ios/getFeedByCat?id=%ld&cat=%d", (long)userId, 1];
